    ...
    fetch("api/pilots.php")
      ...
      .then((pilots) => {
        ...
        if (pilot) {
          ...
          document.getElementById("pilotFormTitle").textContent =
            "Editar Piloto";
          document.getElementById("pilotSubmitBtn").textContent =
            "Actualizar Piloto";
          document.getElementById("pilotCancelBtn").style.display =
            "inline-block";
